    ...
    return (
        <section className="py-20 px-6 bg-gradient-to-r from-purple-200 to-pink-300 text-center">
            ...
            <p className="max-w-xl mx-auto text-lg">
                ...
                our calls, I realize how lucky I am to have you in my life. I am extremely grateful to God for sending
                you into my life. He has blessed me with the most amazing person in the world and I can’t thank him
                enough. I love you so much, and I can’t imagine my life without you.
            </p>
            ...
            <p className="max-w-xl mx-auto text-lg">
                ...
                you by my side. Here’s to many more years of love, joy, and laughter. Happy anniversary, my love! I love
                you to the sun and back! I love you more than anyone in the world has ever loved anyone. I love you, my
                bubu phudu!😘🥰💕
            </p>
        </section>
    );
