    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <div className="h-screen relative overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-20 text-center px-4">
          ...
          <p className="text-2xl md:text-3xl font-light tracking-wide mb-12">
            DAVID & ISHWARI
          </p>
          <a 
            href="#journey" 
      ...
      <nav className="sticky top-0 bg-black/80 backdrop-blur-sm z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <a href="#" className="text-xl font-bold">D&I</a>
          <div className="flex space-x-8">
            <a href="/anniversary" className="hover:text-pink-400 transition">ANNIVERSARY</a>
            <a href="/count-down" className="hover:text-pink-400 transition">COUNTDOWN</a>
            <a href="/wedding-video" className="hover:text-pink-400 transition">WEDDING</a>
          </div>
        </div>
      </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-4 flex flex-col justify-center">
                ...
                <p className="text-gray-400 mb-8 leading-relaxed">
                  Celebrating 365 days of love, laughter, and growth together. 
                  Join us as we reminisce about our first year as a couple and 
                  all the beautiful memories we've created.
                </p>
                <a 
                  href="/anniversary" 
          ...
          <div className="mb-40">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              <div className="lg:col-span-4 lg:col-start-2 flex flex-col justify-center order-2 lg:order-1">
                ...
                <p className="text-gray-400 mb-8 leading-relaxed">
                  Every second brings us closer to our next embrace. Follow our countdown 
                  as we eagerly await the moment we're together again.
                </p>
                <a 
                  href="/count-down" 
                  className="group flex items-center text-lg font-medium"
          ...
          <div className="mb-40">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-4 flex flex-col justify-center">
                ...
                <p className="text-gray-400 mb-8 leading-relaxed">
                  The anticipation builds as we count down to our second meeting. 
                  Each day brings new excitement as we prepare to create more beautiful memories together.
                </p>
                <a 
                  href="/count-down-two" 
                  className="group flex items-center text-lg font-medium"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              <div className="lg:col-span-4 lg:col-start-2 flex flex-col justify-center order-2 lg:order-1">
                ...
                <p className="text-gray-400 mb-8 leading-relaxed">
                  ...
                  Watch our wedding ceremony video to experience all the joy, emotion, and love we shared on that special day.
                </p>
                <a 
                  href="/wedding-video" 
                  className="group flex items-center text-lg font-medium"
              ...
              <div className="lg:col-span-5 order-1 lg:order-2">
                <div className="h-96 md:h-[36rem] relative overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                    <div className="w-20 h-20 rounded-full bg-black/50 backdrop-blur-sm flex items-center justify-center hover:bg-black/70 transition cursor-pointer">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="bg-gradient-to-r from-purple-900 to-pink-800 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="/anniversary" className="px-8 py-3 bg-white text-black hover:bg-gray-200 transition">
              Anniversary
            </a>
            <a href="/count-down" className="px-8 py-3 bg-white text-black hover:bg-gray-200 transition">
              First Countdown
            </a>
            <a href="/count-down-two" className="px-8 py-3 bg-white text-black hover:bg-gray-200 transition">
              Second Countdown
            </a>
            <a href="/wedding-video" className="px-8 py-3 bg-white text-black hover:bg-gray-200 transition">
              Wedding Video
            </a>
          </div>
        </div>
